...
int trackHeight;  // y-location of the carts
int startTime;
...
int chargeDiameter;  //diameter of the charge between the two carts
int maxTime=10000;  //maximum countdown in ms
int score=0;
int hiScore=0;
int level=1;
/*
